...
| **[Vice](https://github.com/jrconradt/Vice)** | CLI framework whose natural-language command grammar is wired by source generators and piped through backpressured channels. |
...
| **[FWHT.Net](https://github.com/jrconradt/FWHT.Net)** | A 9-stage GF(2) Walsh–Hadamard butterfly in one AVX-512 register: ~13 ns per 64-byte window; saturates two-socket DRAM bandwidth (~105 GB/s read+write combined). |
